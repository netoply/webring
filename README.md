...
Σε περίπτωση που προκύψει κάποιο conflict κατά το αίτημά σας για Pull Request στο παρόν/αρχικό αποθετήριο, κρατήστε ένα backup των αλλαγών σας, ανανεώστε το περιεχόμενο του αντιγράφου σας με την εντολή **pull** του git, κάντε τις όποιες αλλαγές χρειάζεται και προχωρήστε σε νέο pull request.
